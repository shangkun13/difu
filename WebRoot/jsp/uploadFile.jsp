			...
			<tr align="center" valign="middle">
						...
						<tr align="center">
							<td height="37" valign="top" align="left">
								...
								<%--<select id="orderType" name="orderType" size = "1">
								  ...
								  文件类型：
									  <input type="radio" id="orderType" name="orderType" value="0" checked="checked"/> 客户
      							  </form>
							</td>
						</tr>
				...
				<td width="30%" colspan="3" align="left" valign="top">
					<font style="font-size: 14px; line-height: 25px">&nbsp;<br />&nbsp;<br />&nbsp;<br />&nbsp;<br />注意事项：<br />
							...
							5. 多个文件时，请一个一个上传，等第一个文件处理完成之后在进行第二个文件的处理。<br />
							6. 文件不可以加密，否则无法识别。<br />
							7. 如果要导入的手机号已经存在，则被过滤掉。<br />
							<a href="Contacts.xls" target="_blank">下载客户模板</a>
							</br>
